...
class UpdateRecruitmentCandidateRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            'candidate_code' => ['nullable', 'string', 'max:40', Rule::unique('recruitment_candidates', 'candidate_code')->ignore($candidate?->id)],
            'full_name' => ['sometimes', 'string', 'min:3', 'max:150'],
            'email' => ['sometimes', 'email', 'max:255', Rule::unique('recruitment_candidates', 'email')->ignore($candidate?->id)],
