...
import { AnalyticsApiPreviewPanel } from './analytics-api-preview-panel';
import { type AnalyticsCapabilityItem } from './analytics-capability-catalog';

export function AnalyticsDetailPage({ capability }: { capability: AnalyticsCapabilityItem }) {
  return (
    <div className="space-y-4">
      ...
      <div className="grid gap-4 xl:grid-cols-[0.95fr_1.05fr]">
        <SurfaceCard className="space-y-4">
          <div className="flex flex-wrap items-center justify-between gap-3">
            <div>
              ...
              <h3 className="text-xl font-semibold">Yang dibuka lebih cepat oleh lane ini</h3>
            </div>
        ...
        <AnalyticsApiPreviewPanel capability={capability} />
      </div>
      ...
      <SurfaceCard className="space-y-4">
        <div className="flex flex-wrap items-center justify-between gap-3">
          <div>
            ...
            <h3 className="text-xl font-semibold">Lanjut ke jalur BI yang terhubung</h3>
          </div>
