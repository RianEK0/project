...
import { PlatformApiPreviewPanel } from './platform-api-preview-panel';
import { type PlatformCapabilityItem } from './platform-capability-catalog';

export function PlatformDetailPage({ capability }: { capability: PlatformCapabilityItem }) {
  return (
    <div className="space-y-4">
      ...
      <div className="grid gap-4 xl:grid-cols-[0.95fr_1.05fr]">
        ...
        <PlatformApiPreviewPanel capability={capability} />
      </div>
      ...
      <SurfaceCard className="space-y-4">
        <div className="flex flex-wrap items-center justify-between gap-3">
          <div>
            ...
            <h3 className="text-xl font-semibold">Lanjut ke jalur platform yang terhubung</h3>
          </div>
