...
type ProcurementPlaceholderPageProps = {
  eyebrow: string;
  title: string;
  description: string;
...
export function ProcurementPlaceholderPage({
  eyebrow,
  title,
  description,
  highlights,
  relatedLinks = [],
  badgeLabel = 'Sprint 3C Foundation',
}: ProcurementPlaceholderPageProps) {
  return (
        ...
        <SurfaceCard className="space-y-4">
          <div className="flex flex-wrap items-center justify-between gap-3">
            <div>
              ...
              <h3 className="text-xl font-semibold">Lanjut ke jalur procurement</h3>
            </div>
