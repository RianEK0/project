...
import { DocumentApiPreviewPanel } from './document-api-preview-panel';
import { type DocumentCapabilityItem } from './document-capability-catalog';

export function DocumentDetailPage({ capability }: { capability: DocumentCapabilityItem }) {
  return (
    <div className="space-y-4">
      <SurfaceCard tone="accent" className="space-y-5">
        <div className="flex flex-wrap items-center justify-between gap-3">
          ...
          <div className="flex flex-wrap items-center gap-2">
            <StatusBadge tone="success">Documents Workspace</StatusBadge>
      ...
      <div className="grid gap-4 xl:grid-cols-[0.95fr_1.05fr]">
        <SurfaceCard className="space-y-4">
          <div className="flex flex-wrap items-center justify-between gap-3">
            <div>
              ...
              <h3 className="text-xl font-semibold">Yang dibuka lebih cepat oleh lane dokumen ini</h3>
            </div>
        ...
        <DocumentApiPreviewPanel capability={capability} />
      </div>
      ...
      <SurfaceCard className="space-y-4">
        <div className="flex flex-wrap items-center justify-between gap-3">
          <div>
            ...
            <h3 className="text-xl font-semibold">Lanjut ke workflow dokumen yang terhubung</h3>
          </div>
