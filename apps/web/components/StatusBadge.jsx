const statusClass = {
  ...
  "Arsip Aktif": "bg-emerald-50 text-emerald-700 border-emerald-200",
  "Arsip Inaktif": "bg-amber-50 text-amber-700 border-amber-200",
  "Arsip Statis": "bg-indigo-50 text-indigo-700 border-indigo-200",
  "Arsip Musnah": "bg-red-50 text-red-700 border-red-200",
