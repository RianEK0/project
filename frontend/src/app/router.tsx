import { Building2, CalendarClock, LayoutDashboard, LogOut, ShieldCheck, Users } from 'lucide-react'
...
function AppShell() {
  ...
  ].filter((item) => !item.permission || session?.user.permissions.includes(item.permission))
            ...
            <div className="space-y-3">
              ...
              <div className="space-y-2">
                ...
                <p className="max-w-2xl text-sm leading-7 text-app-muted-foreground md:text-base">
                  Pantau data karyawan, struktur organisasi, approval cuti, dan audit trail
                  dari satu ruang kerja yang konsisten.
                </p>
              </div>
            </div>
          </div>
